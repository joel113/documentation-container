...
public class TableToTableJoinIntegrationTest {
  ...
  public void shouldJoinTwoTables() {
    ...
    try (final TopologyTestDriver topologyTestDriver = new TopologyTestDriver(builder.build(), streamsConfiguration)) {
      ...
      //
      MatcherAssert.assertThat(output.readKeyValuesToList(), CoreMatchers.equalTo(expectedResults));
      ...
      MatcherAssert.assertThat(storeData, CoreMatchers.equalTo(expectedResultsForJoinStateStore));
    }
  }
}
