...
public class PriorityQueueSerdeTest {
    ...
    public void shouldSerializeDeserialize() {
        ...
        MatcherAssert.assertThat(result.poll(), CoreMatchers.equalTo(1L));
        MatcherAssert.assertThat(result.poll(), CoreMatchers.equalTo(2L));
        MatcherAssert.assertThat(result.poll(), CoreMatchers.nullValue());
    }
