...
public class WordCountInteractiveQueriesExampleTest {
  ...
  public void shouldDemonstrateInteractiveQueries() throws Exception {
    ...
    TestCase.assertTrue("streams failed to start within timeout", startupLatch.await(60, TimeUnit.SECONDS));
    ...
    if (proxy != null) {
      ...
      assertThat(hostStoreInfo, IsCollectionContaining.hasItem(
      ...
      assertThat(wordCountInstances, IsCollectionContaining.hasItem(
        new HostStoreInfo(host, port, Sets.newHashSet("word-count", "windowed-word-count"))
      ));
      ...
      MatcherAssert.assertThat(all, IsEqual.equalTo(allValues));
      ...
      MatcherAssert.assertThat(range, IsEqual.equalTo(expectedRange));
      ...
      MatcherAssert.assertThat(result, IsEqual.equalTo(new KeyValueBean("hello", 2L)));
      ...
      MatcherAssert.assertThat(windowedResult.size(), IsEqual.equalTo(1));
      final KeyValueBean keyValueBean = windowedResult.get(0);
      assertTrue(keyValueBean.getKey().startsWith("streams"));
      assertThat(keyValueBean.getValue(), IsEqual.equalTo(3L));
    } else {
      TestCase.fail("Should fail demonstrating InteractiveQueries as the Rest Service failed to start.");
    }
  }
  ...
  public void shouldThrowBindExceptionForUnavailablePort() throws Exception {
    ...
    MatcherAssert.assertThat(exception.getCause(), CoreMatchers.instanceOf(BindException.class));
  }
