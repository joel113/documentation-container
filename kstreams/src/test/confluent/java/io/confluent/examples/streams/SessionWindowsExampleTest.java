...
public class SessionWindowsExampleTest {
  ...
  public void shouldCountPlayEventsBySession() {
    ...
    MatcherAssert.assertThat(firstSession.get(0), CoreMatchers.equalTo(KeyValue.pair(userId + "@" +start+"->"+start, 1L)));
    ...
    MatcherAssert.assertThat(next.key, CoreMatchers.equalTo(new Windowed<>(userId, new SessionWindow(start, start))));
    MatcherAssert.assertThat(next.value, CoreMatchers.equalTo(1L));
    ...
    MatcherAssert.assertThat(secondSession.get(0), CoreMatchers.equalTo(KeyValue.pair(userId + "@" + secondSessionStart + "->" + secondSessionStart,
                                                           1L)));
    ...
    MatcherAssert.assertThat(results, CoreMatchers.equalTo(Arrays.asList(KeyValue.pair(new Windowed<>(userId, new SessionWindow(start, start)),1L),
    ...
    // merged
    MatcherAssert.assertThat(merged, CoreMatchers.equalTo(Arrays.asList(KeyValue.pair(userId + "@" +start+"->"+start, null),
    ...
    MatcherAssert.assertThat(mergedResults, CoreMatchers.equalTo(Collections.singletonList(KeyValue.pair(new Windowed<>(userId, new SessionWindow(start, secondSessionStart)), 3L))));
  }
