...
public class FanoutLambdaIntegrationTest {
  ...
  public void shouldFanoutTheInput() {
    ...
    try (final TopologyTestDriver topologyTestDriver = new TopologyTestDriver(builder.build(), streamsConfiguration)) {
      ...
      MatcherAssert.assertThat(outputB.readValuesToList(), CoreMatchers.equalTo(expectedValuesForB));
      // Verify output topic C
      MatcherAssert.assertThat(outputC.readValuesToList(), CoreMatchers.equalTo(expectedValuesForC));
    }
  }
}