...
public class WordCountLambdaExampleTest {
  ...
  public void testOneWord() {
    ...
    MatcherAssert.assertThat(output, CoreMatchers.equalTo(KeyValue.pair("hello", 1L)));
  ...
  public void shouldCountWords() {
    ...
    MatcherAssert.assertThat(outputTopic.readKeyValuesToMap(), CoreMatchers.equalTo(expectedWordCounts));
  }
